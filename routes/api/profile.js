...
router.post('/experience', passport.authenticate('jwt', {
    ...
    Profile.findOne({
        ...
        .then(profile => {
            ...
            // add to experience array push will put at end so unshif
            profile.experience.unshift(newExp);
            // take the existing profile and save the profile
...
// @desc Delete Education form the profile
// @access Private Route
